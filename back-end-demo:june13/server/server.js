//cors allows computers with differnt ip address to connect
//express is a virtual server
...
const inventory = ['greeting card', 'wagon', 'computer', 'table', 'chair', 
'milk', 'sailboat', 'conditoner','rusy nail', 'desk']
